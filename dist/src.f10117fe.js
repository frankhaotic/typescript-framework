  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (value) {
        var item = _this.deserialize(value);
...
},{"axios":"node_modules/axios/index.js","./Eventing":"src/models/Eventing.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
users.fetch();
},{"./models/Collection":"src/models/Collection.ts","./views/UserList":"src/views/UserList.ts","./models/User":"src/models/User.ts"}],"../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
